...
type ProtoGenerator struct {
	Options           *Options
	annotatedFields   map[string]string // maps protoFieldName -> moduleName for CEL-annotated fields
...
func (g *ProtoGenerator) GenerateDevice(modules []*schema.Module, w io.Writer) error {
	...
	g.annotatedFields = make(map[string]string)
		...
		if g.Options.GenerateCELValidation {
			...
			if validateOpt != "" {
				...
				if g.annotatedFields != nil {
					g.annotatedFields[fieldName] = g.currentModuleName
				}
			}
		}
