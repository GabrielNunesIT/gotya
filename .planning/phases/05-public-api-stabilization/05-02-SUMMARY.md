...
plan: 02
subsystem: api
tags: [gotya, tdd, green, public-api, ParseError, Diagnostic, parser, lexer]

# Dependency graph
requires:
  - phase: 05-public-api-stabilization
    plan: 01
    provides: "RED test stubs in gotya_test.go covering ParseError, Diagnostic, multi-error, and ParseFile File-filled behavior"
provides:
...
tech-stack:
  added: []
  patterns: [errors-As-parseError, structured-diagnostics, tdd-green, rfc7950-identifier-validation]
